...
var (
	...
	argCheckActiveInstanceNum = flag.Bool("checkactivenum", false, "input checknum")
...
func main() {
	...
	if *argResource == "as" {
		if *argASG != "" {
			...
			} else if *argCheckActiveInstanceNum {
				clitoolgoaws.GetInstanceStatus(asClient, argASG)
			} else if *argDesire {
